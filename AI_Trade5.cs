...
namespace Matriks.Lean.Algotrader
{
	public class a5 : MatriksAlgo
	{
		...
		[Parameter(0.4, "Kar Al Stop Seviyesi")]
		...
		[Parameter(0.4, "Zarar Durdur Stop Seviyesi")]
		public decimal StopLossStopLevel;

		AlgoAiPredictionModel algoAiPredictionModel;
		string AiModelName = "BTC_USDT_BIN_15dk_YukselisMode";
