...
namespace Matriks.Lean.Algotrader
{
	public class a7 : MatriksAlgo
	{
		...
		[Parameter(10, "Kar Al Stop Seviyesi")]
		...
		[Parameter(10, "Zarar Durdur Stop Seviyesi")]
		public decimal StopLossStopLevel;

		AlgoAiPredictionModel algoAiPredictionModel;
		string AiModelName = "BIST30_Aylik_YukselisModeli";
